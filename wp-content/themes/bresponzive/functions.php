...
if (!isset( $content_width )) $content_width = 580;
 function bresponZive_themepacific_themepacific_breadcrumb() {
	if (!is_home()) {
		...
		echo '<ul id="tpcrn-breadcrumbs"><li><a href="'.esc_url(home_url()).'">Inicio &raquo;</a> </li>';
...
function bresponZive_themepacific_single_split_page_links($defaults) {
	$args = array(
	'before' => '<div class="single-split-page"><p>' . __('<strong>P&aacute;ginas</strong>','bresponZive'),
	'after' => '</p></div>',
	'pagelink' => '%',
	);
	...
	<li id="comment-<?php comment_ID(); ?>">
		<div <?php comment_class('comment-wrapper'); ?> >
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em class="comment-awaiting-moderation"><?php _e( 'Su comentario esta esperando aprobación del moderador.', 'bresponZive' ); ?></em>
					<br />
				<?php endif; ?>
