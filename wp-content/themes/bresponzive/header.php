...
<link rel='stylesheet' href='<?php echo get_template_directory_uri(); ?>/css/gen.css' type='text/css' media='all' />
...
<div id="wrapperHeaderGen">
 <div id="headerGen">
  <a target="_blank" href="http://www.partidogen.org.ar"><img src="<?php echo get_template_directory_uri(); ?>/images/margarita-genmoron-all.png" alt="Partido GEN" /></a>
 </div> 
</div>
